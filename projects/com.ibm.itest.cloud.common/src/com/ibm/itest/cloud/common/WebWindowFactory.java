 ...
 *********************************************************************/
package com.ibm.itest.cloud.common;
 ...
 */
public class WebWindowFactory extends Factory {

private WebWindowFactory() {
    super(null);
}
 ...
 * not exist.
 */
public static <W extends AbstractWindow> W createInstance(final WebPage page, final Class<W> windowClass) throws Exception {
 ...
 * not exist.
 */
public static <W extends AbstractWindow> W createInstance(final WebPage page, final Class<W> windowClass, final String... data) throws Exception {
 ...
 * not exist.
 */
public static <W extends AbstractWindow> W createInstance(final WebPage page, final By locator, final Class<W> windowClass) throws Exception {
...
public static <W extends AbstractWindow> W createInstance(final WebPage page, final By locator, final Class<W> windowClass, final String... data) throws Exception {
