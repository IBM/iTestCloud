 ...
 * </p>
 */
public class AbstractExpandableElement extends WebElementWrapper implements ExpandableElement {
 ...
 * <p>
 * Important: This constructor is only used for initializing {@link AbstractDynamicExpandableElement} and
 * should not be used for any other purposes.
 * </p>
 * @param parent The wrapped web element parent
 */
protected AbstractExpandableElement(final WebElementWrapper parent) {
	super(parent);
}
 ...
 */
public AbstractExpandableElement(final WebElementWrapper parent, final By locator) {
 ...
 */
public AbstractExpandableElement(final WebElementWrapper parent, final By locator, final By expansionLocator) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebElementWrapper parent, final By locator, final WebBrowserFrame frame, final By expansionLocator) {
 ...
 */
public AbstractExpandableElement(final WebElementWrapper parent, final WebBrowserElement webElement) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebElementWrapper parent, final WebBrowserElement webElement, final By expansionLocator) {
	this(parent, webElement, (WebBrowserElement) null /*expansionElement*/);
	this.expansionElement = getExpansionElement(expansionLocator);
}
 ...
 */
public AbstractExpandableElement(final WebElementWrapper parent, final WebBrowserElement webElement, final WebBrowserElement expansionElement) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebElementWrapper parent, final WebBrowserElement webElement, final WebBrowserFrame frame, final By expansionLocator) {
 ...
 */
protected AbstractExpandableElement(final WebPage page) {
	super(page);
}
 ...
 * @param locator The locator to find the wrapped web element
 */
public AbstractExpandableElement(final WebPage page, final By locator) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebPage page, final By locator, final By expansionLocator) {
	super(page, locator);
	this.expansionElement = getExpansionElement(expansionLocator);
}
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebPage page, final By locator, final WebBrowserFrame frame, final By expansionLocator) {
 ...
 * @param webElement The wrapped web element
 */
public AbstractExpandableElement(final WebPage page, final WebBrowserElement webElement) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebPage page, final WebBrowserElement webElement, final By expansionLocator) {
 ...
 * @param expansionLocator The locator to find the expansion web element
 */
public AbstractExpandableElement(final WebPage page, final WebBrowserElement webElement, final WebBrowserFrame frame, final By expansionLocator) {
 ...
 *
 * @return The expansion element as {@link WebBrowserElement}.
 */
protected WebBrowserElement getExpansionElement(final By expansionLocator) {
	...
	return waitForElement(expansionLocator);
}
