...
import static com.ibm.itest.cloud.common.utils.ByUtils.toRelative;
...
public class SearchBarElement extends ElementWrapper {
	...
	private static final String INPUT_ELEMENT_LOCATOR = "//*[contains(@class,'bx--search-input')]";

public static By getCloseButtonLocator(final boolean relative) {
	return relative ? toRelative(CLOSE_BUTTON_LOCATOR) : By.xpath(CLOSE_BUTTON_LOCATOR);
}

private static By getSearchInputElementLocator(final boolean relative) {
	return relative ? toRelative(INPUT_ELEMENT_LOCATOR) : By.xpath(INPUT_ELEMENT_LOCATOR);
}
