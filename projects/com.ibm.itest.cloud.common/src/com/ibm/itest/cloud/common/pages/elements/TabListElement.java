...
public TabListElement(final ElementWrapper parent, final By findBy) {
	super(parent, findBy);
}

public TabListElement(final ElementWrapper parent, final BrowserElement element) {
	super(parent, element);
}

public TabListElement(final Page page, final By findBy) {
	super(page, findBy);
}

public TabListElement(final Page page, final BrowserElement element) {
	super(page, element);
}
...
protected void clickOnOpenLinkElement(final Pattern pattern) {
	BrowserElement openLinkElement = getOpenLinkElement(pattern);
 ...
 */
protected abstract BrowserElement getOpenLinkElement(final Pattern pattern);
 ...
 */
public <T extends TabElement> T openTab(final Pattern pattern, final Class<T> tabClass, final boolean force, final String... data) {
	...
	try {
		if((data == null) || (data.length == 0)) {
			...
			if(this.parent != null) {
				tab = tabClass.getConstructor(ElementWrapper.class, String[].class).newInstance(getParent(), data);
			}
			else {
 ...
 * @return The opened tab as a subclass of {@link TabElement}
 */
public <T extends TabElement> T openTab(final Pattern pattern, final Class<T> tabClass, final String... data) {
 ...
 * @return The opened tab as a subclass of {@link TabElement}
 */
public <T extends TabElement> T openTab(final String name, final Class<T> tabClass, final boolean force, final String... data) {
 ...
 * @return The opened tab as a subclass of {@link TabElement}
 */
public <T extends TabElement> T openTab(final String name, final Class<T> tabClass, final String... data) {
