 ...
 * </ul>
  * </p>
 */
abstract public class WebRichHover<P extends WebPage> extends WebLinkHover<P> {

public WebRichHover(final WebPage page) {
	super(page);
}
...
protected void closeAction(final boolean cancel) {
	...
	resetFrame();
	WebBrowserElement closeLinkElement = this.browser.findElement(By.xpath(getCloseButton(cancel)), false/*no recovery*/);
