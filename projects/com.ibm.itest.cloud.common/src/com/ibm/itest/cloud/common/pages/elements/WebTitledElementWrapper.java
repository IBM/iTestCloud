 ...
 * </p>
 */
public abstract class WebTitledElementWrapper extends WebElementWrapper {

	protected String[] data;

public WebTitledElementWrapper(final WebElementWrapper parent, final By findBy) {
	this(parent, findBy, (String[]) null);
}

public WebTitledElementWrapper(final WebElementWrapper parent, final By findBy, final String... data) {
	super(parent, findBy);
	this.data = data;
}

public WebTitledElementWrapper(final WebPage page) {
	this(page, (String[]) null);
}

public WebTitledElementWrapper(final WebPage page, final By findBy) {
	this(page, findBy, (String[]) null);
}

public WebTitledElementWrapper(final WebPage page, final By findBy, final String... data) {
	super(page, findBy);
	this.data = data;
}

public WebTitledElementWrapper(final WebPage page, final String... data) {
	super(page);
	this.data = data;
}

public WebTitledElementWrapper(final WebPage page, final WebBrowserElement element) {
	this(page, element, (String[]) null);
}

public WebTitledElementWrapper(final WebPage page, final WebBrowserElement element, final String... data) {
	super(page, element);
	this.data = data;
}
