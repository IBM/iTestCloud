...
public WaitElementTimeoutError(final String message, final AbstractDialog dialog) {
...
public WaitElementTimeoutError(final Throwable ex, final AbstractDialog dialog) {
	super(ex, dialog);
}
