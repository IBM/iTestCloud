...
//	private final static Map<String, WebPage> CLM_PAGES = new WeakHashMap<String, WebPage>();
	...
	*/
	private final static ThreadLocal<List<WebPage>> PAGES_HISTORY = new ThreadLocal<List<WebPage>>();

	static {
		PAGES_HISTORY.set(new ArrayList<WebPage>());
	}
	...
	private static List<WebPage> getPagesHistory() {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <P extends WebPage> P getPageUsingBrowser(final Config config, final User user, final Class<P> pageClass, final String... data) {
	 ...
	 * @return The instance of the class associate with the page.
	 */
	public static WebPage reopenPage(final WebPage page, final IUser user) {
	 ...
	 */
	public static WebPage searchPageInHistory(final String location) {
		final List<WebPage> pagesHistory = getPagesHistory();
		int size = pagesHistory.size();
...
// Web elements
protected WebBrowserElement bodyElement;
...
public WebPage(final String url, final Config config, final User user) {
	this(url, config, user, NO_DATA);
}

public WebPage(final String url, final Config config, final User user, final String... data) {
 ...
 */
protected WebBrowserElement check(final By findBy) {
 ...
 * @see #check(WebBrowserElement, By, int, boolean)
 */
protected WebBrowserElement check(final WebBrowserElement parentElement, final By findBy) {
 ...
 * @see WebBrowser#check(WebBrowserElement, int, boolean)
 */
protected WebBrowserElement check(final WebBrowserElement parentElement, final By findBy, final int toggle, final boolean validate) {
 ...
 */
protected WebBrowserElement click(final By findBy) {
 ...
 * @see WebBrowserElement#click()
 */
protected WebBrowserElement click(final By parentBy, final By findBy) {
	if (DEBUG) debugPrintln("		+ Click on "+(parentBy==null ? "" : parentBy+"//")+findBy);
	WebBrowserElement parentElement = parentBy == null ? null : waitForElement(parentBy);
 ...
 * @see WebBrowserElement#click()
 */
public WebBrowserElement click(final WebBrowserElement parentElement, final By findBy) {
...
private WebBrowserElement getBodyElement() {
 ...
 *
 * @deprecated Use {@link WebBrowser#getDownloadDirContents()} instead.
 */
@Deprecated
 ...
 */
protected List<WebBrowserElement> getFrames() {
...
protected WebBrowserElement getLoggedUserElement(final boolean fail, final int waitTimeout) throws WaitElementTimeoutError {
 ...
 *
 * @deprecated Use {@link WebBrowser#getNewFileInDownloadDir(List)} instead.
 */
@Deprecated
 ...
 */
protected final WebBrowserElement getRootElement() {
...
public String getTitle() {
	WebBrowserElement titleElement = waitForTitle(true /*fail*/);
...
public WebPage goBack() {
	...
	List<WebPage> pagesHistory = getPagesHistory();
	int size = pagesHistory.size();
	if (size < 2) {
...
protected boolean isLoaded() {
	...
	// Checking iFrames
	for (WebBrowserElement frameElement : getFrames()) {
 ...
 * <code>false</code> otherwise.
 */
abstract protected boolean matchDisplayedUser(User user, WebBrowserElement loggedUserElement);
 ...
 * @return The instance of the class associate with the page.
 */
public <P extends WebPage> P openAndWaitForPage(final String pageLocation, final IConfig newConfig, final IUser newUser, final Class<P> pageClass, final String... pageData) {
 ...
 * having clicked on the link.
 */
public <P extends WebElementWrapper> P openElementUsingLink(final WebBrowserElement linkElement, final By findBy, final Class<P> elementClass, final ClickType clickType, final String... elementData) {
	...
	try {
		if(findBy != null) {
			if((elementData == null) || (elementData.length == 0)) {
				element = elementClass.getConstructor(WebPage.class, By.class).newInstance(this, findBy);
			}
			else {
				element = elementClass.getConstructor(WebPage.class, By.class, String[].class).newInstance(this, findBy, elementData);
			}
		}
		else {
			if((elementData == null) || (elementData.length == 0)) {
				element = elementClass.getConstructor(WebPage.class).newInstance(this);
			}
			else {
				element = elementClass.getConstructor(WebPage.class, String[].class).newInstance(this, elementData);
			}
		}
	}
	catch (WebDriverException e) {
 ...
 */
public <P extends WebPage> P openPageUsingLink(final By linkBy, final Class<P> openedPageClass) {
 ...
 * @see #openPageUsingLink(WebBrowserElement, By, Class, boolean, int, String...)
 */
public <P extends WebPage> P openPageUsingLink(final By linkBy, final Class<P> openedPageClass, final String... info) {
 ...
 * @see #openPageUsingLink(WebBrowserElement, Class, String...)
 * @see WebBrowserElement#click()
 */
public <P extends WebPage> P openPageUsingLink(final WebBrowserElement parentElement, final By linkBy, final Class<P> openedPageClass, final boolean fail, final int time_out, final String... info) {
	WebBrowserElement linkElement = this.browser.waitForElement(parentElement, linkBy, fail, time_out, true/*visible*/, true/*single element expected*/);
	if (linkElement == null) return null;
	return openPageUsingLink(linkElement, openedPageClass, info);
}

public <P extends WebPage> P openPageUsingLink(final WebBrowserElement parentElement, final By linkBy, final Class<P> openedPageClass, final String... pageData) {
 ...
 */
@SuppressWarnings("unchecked")
public <P extends WebPage> P openPageUsingLink(final WebBrowserElement linkElement, final User user, final Class<P> openedPageClass, final Action postLinkClickAction, final String... pageData) {
 ...
 * having clicked on the link
 */
public <P extends WebPage> P openPageUsingLink(final WebBrowserElement linkElement, final User user, final Class<P> openedPageClass, final String... pageData) {
	return openPageUsingLink(linkElement, user, openedPageClass, null /*prePageOpenAction*/, pageData);
}

@SuppressWarnings("unchecked")
public <P extends IWebPage> P openPageUsingLink2(final WebBrowserElement parentElement, final By linkBy, final Class<P> openedPageClass) {
	return (P) openPageUsingLink(parentElement, linkBy, (Class<? extends WebPage>) openedPageClass, true/*fail*/, timeout());
}

@SuppressWarnings("unchecked")
public <P extends IWebPage> P openPageUsingLink2(final WebBrowserElement parentElement, final By linkBy, final Class<P> openedPageClass, final boolean fail, final int time_out, final String... info) {
	return (P) openPageUsingLink(parentElement, linkBy, (Class<? extends WebPage>) openedPageClass, fail, time_out, info);
}

@SuppressWarnings("unchecked")
public <P extends IWebPage> P openPageUsingLink2(final WebBrowserElement linkElement, final Class<P> openedPageClass, final String... pageData) {
	return (P) openPageUsingLink(linkElement, (Class<? extends WebPage>) openedPageClass, pageData);
}
...
public void refresh() {
	...
	if (!this.location.equals(browserUrl)) {
		WebPage historyPage = searchPageInHistory(this.location);
		if (historyPage != null) {
...
protected void verifyPageUser() throws ScenarioFailedError {
	...
	// Check whether the current page is on the expected user or not
	WebBrowserElement loggedUserElement = getLoggedUserElement(false/*fail*/, timeout());
 ...
 * @see WebBrowser#waitForElement(WebBrowserElement, By, boolean, int, boolean, boolean)
 */
public WebBrowserElement waitForElement(final By locator, final boolean displayed, final boolean single) {
 ...
 * @see WebBrowser#waitForElement(WebBrowserElement, By, boolean, int, boolean, boolean)
 */
public WebBrowserElement waitForElement(final By locator, final boolean fail, final int time_out) {
 ...
 * @see WebBrowser#waitForElement(WebBrowserElement, By, boolean, int, boolean, boolean)
 */
public WebBrowserElement waitForElement(final By locator, final boolean fail, final int time_out, final boolean displayed, final boolean single) {
 ...
 */
public WebBrowserElement waitForElement(final By parentLocator, final By locator) {
 ...
 * @see WebBrowser#waitForElement(WebBrowserElement, By, boolean, int, boolean, boolean)
 */
public WebBrowserElement waitForElement(final WebBrowserElement parentElement, final By locator, final boolean displayed) {
 ...
 * @see WebBrowser#waitForElement(WebBrowserElement, By, boolean, int, boolean, boolean)
 */
public WebBrowserElement waitForElement(final WebBrowserElement parentElement, final By locator, final boolean fail, final int time_out) {
 ...
 * @see WebBrowser#waitForElements(WebBrowserElement, By, boolean, int, boolean)
 */
public List<WebBrowserElement> waitForElements(final By locator, final boolean fail, final int time_out) {
 ...
 * @see WebBrowser#waitForElements(WebBrowserElement, By, boolean, int, boolean)
 */
public List<WebBrowserElement> waitForElements(final By locator, final int time_out) {
 ...
 * @see WebBrowser#waitForElements(WebBrowserElement, By, boolean, int, boolean)
 */
public List<WebBrowserElement> waitForElements(final By locator, final int time_out, final boolean displayed) {
 ...
 * @see WebBrowser#waitForElements(WebBrowserElement, By, boolean, int, boolean)
 */
public List<WebBrowserElement> waitForElements(final WebBrowserElement parentElement, final By locator) {
 ...
 */
public WebBrowserElement[] waitForMultipleElements(final boolean fail, final int time_out, final By... findBys) {
 ...
 * to have more details on how the returned array is filled with found elements
 */
public WebBrowserElement[] waitForMultipleElements(final By... findBys) {
 ...
 * to have more details on how the returned array is filled with found elements
 */
public WebBrowserElement[] waitForMultipleElements(final WebBrowserElement parentElement, final By... findBys) {
 ...
 * @see WebBrowser#waitForText(WebBrowserElement, boolean, int, String...)
 */
public WebBrowserElement waitForTextPresent(final ComparisonPattern pattern, final String... texts) {
 ...
 * and does not override this method.
 */
protected WebBrowserElement waitForTitle(final boolean fail) {
	if (isTitleExpected()) {
		try {
