 ...
 * </ul>
  * </p>
 */
abstract public class WebTextHover extends AbstractWindow {
	...
	protected WebBrowserElement linkElement;

public WebTextHover(final WebPage page) {
...
public static void waitAndCancel(final WebPage page) {
	WebBrowserElement dialogElement = page.waitForElement(DEFAULT_TEXT_HOVER_LOCATOR, false/*fail*/, 1/*sec*/);
...
public String getText() {
	...
	// Get content element
	WebBrowserElement contentElement = waitForElement(By.xpath(".//div[@dojoattachpoint='content']"), openTimeout());
