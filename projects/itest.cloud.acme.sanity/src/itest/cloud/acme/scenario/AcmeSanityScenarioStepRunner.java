 ...
 * scenario execution object (see {@link AcmeSanityScenarioExecution}) in the case
 * the scenario step is executed as a single JUnit test class.
 * </p>
 */
public class AcmeSanityScenarioStepRunner extends AcmeScenarioStepRunner {

public AcmeSanityScenarioStepRunner(final Class< ? > klass) throws InitializationError {
	super(klass);
}
