 ...
 * </p>
 */
public abstract class IbmConfirmationDialog extends ConfirmationDialog {

public IbmConfirmationDialog(final Page page) {
	super(page, DIALOG_LOCATOR);
}

public IbmConfirmationDialog(final Page page, final String... data) {
