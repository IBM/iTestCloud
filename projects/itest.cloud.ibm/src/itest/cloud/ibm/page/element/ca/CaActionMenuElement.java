 ...
 * </p>
 */
public class CaActionMenuElement extends IbmDynamicDropdownlistElement {

public CaActionMenuElement(final ElementWrapper parent) {
	super(parent, By.xpath(".//*[contains(@class,'commonMenuActive')]"), By.xpath(".//div") /*find xpath*/, null /*selectionLocator*/, By.xpath(".//*[contains(@class,'commonMenuLink')]/*"));
}
}