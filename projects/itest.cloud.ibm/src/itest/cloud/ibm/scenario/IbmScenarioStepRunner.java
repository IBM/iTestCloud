 ...
 * </p>
 */
public class IbmScenarioStepRunner extends ScenarioStepRunner {
...
public IbmScenarioStepRunner(final Class< ? > klass) throws InitializationError {
	super(klass);
...
protected void startExecution() {
	this.scenarioExecution = new IbmScenarioExecution();
}
