...
/**
 * Annotation to identify whether a step or test related to the Chrome borwser.
 * <p>
 * Such a step or test will be run if the parameter <b>runChromeTests</b> is set to true,
