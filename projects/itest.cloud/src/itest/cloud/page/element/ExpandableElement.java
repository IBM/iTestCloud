...
import static itest.cloud.scenario.ScenarioUtil.debugPrintStackTrace;
 ...
 * </p>
 */
public abstract class ExpandableElement extends ElementWrapper implements IExpandableElement {
...
/**
 * Perform an action to expand or collapse the current web element.
 * <p>
 * If the web element is already in the desired state, then nothing happens.
 * </p>
 * @throws WaitElementTimeoutError If the desired action can not be performed or the intended outcome can not be achieved.
 */
protected void performAction(final boolean expand) throws ScenarioFailedError {
