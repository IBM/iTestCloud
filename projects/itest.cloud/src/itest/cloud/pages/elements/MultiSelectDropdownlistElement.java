...
public MultiSelectDropdownlistElement(final ElementWrapper parent, final By findBy, final By expansionLocator, final By selectionLocator) {
	super(parent, findBy, expansionLocator, selectionLocator);
}

public MultiSelectDropdownlistElement(final Page page, final By findBy, final By expansionLocator, final By selectionLocator) {
	super(page, findBy, expansionLocator, selectionLocator);
}

public MultiSelectDropdownlistElement(final Page page, final BrowserElement webElement, final By expansionLocator, final By selectionLocator) {
	super(page, webElement, expansionLocator, selectionLocator);
}

@Override
protected By getOptionElementLocator() {
	return By.xpath(".//*[contains(@class,'menu-item')]");
}
