 ...
 * {@link itest.cloud.pages.elements.ITableElement.SortMode} enumeration.
 * </p><p>
 ...
 * @return The sorting mode as a {@link itest.cloud.pages.elements.ITableElement.SortMode}
...
public List<BrowserElement> search(final String searchText, final StringComparisonCriterion comparison, final boolean fail, final int column) {
	...
	return waitForElements(By.xpath(xpathExpression), tinyTimeout(), fail);
}
